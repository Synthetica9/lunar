...
make_tunable_params! {
    ...
    corrhist_pawn_weight: Depth = 0.0859375, 0.0, 0.3, 0.01, 0.002;
    corrhist_minor_weight: Depth = 0.0859375, 0.0, 0.3, 0.01, 0.002;
    corrhist_continuation_weight: Depth = 0.0859375, 0.0, 0.3, 0.01, 0.002;
}
