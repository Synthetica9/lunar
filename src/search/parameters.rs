...
make_tunable_params! {
    ...
    corrhist_pawn_weight: Depth = 0.5, 0.0, 1.0, 0.05, 0.002;
    corrhist_minor_weight: Depth = 0.10, 0.0, 1.0, 0.05, 0.002;
    corrhist_krp_weight: Depth = 0.10, 0.0, 1.0, 0.05, 0.002;
    corrhist_krn_weight: Depth = 0.10, 0.0, 1.0, 0.05, 0.002;
    corrhist_krb_weight: Depth = 0.10, 0.0, 1.0, 0.05, 0.002;
    corrhist_major_weight: Depth = 0.10, 0.0, 1.0, 0.05, 0.002;
    corrhist_np_ours_weight: Depth = 0.10, 0.0, 1.0, 0.05, 0.002;
    corrhist_np_theirs_weight: Depth = 0.10, 0.0, 1.0, 0.05, 0.002;
}
