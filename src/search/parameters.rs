...
make_tunable_params! {
    ...
    corrhist_pawn_weight: Depth = 0.24, 0.0, 1.0, 0.05, 0.002;
    corrhist_minor_weight: Depth = 0.24, 0.0, 1.0, 0.05, 0.002;
    corrhist_major_weight: Depth = 0.24, 0.0, 1.0, 0.05, 0.002;
}
